...
void GPIO_EnablePullUp(uint8_t portname, uint8_t pinnumber)
{
    switch(portname)
    {
        case 'A':
        case 'a':
            SET_BIT(GPIO_PORTA_PUR_R, pinnumber);  // Enable pull-up resistor for pin in Port A
            break;
            
        case 'B':
        case 'b':
            SET_BIT(GPIO_PORTB_PUR_R, pinnumber);  // Enable pull-up resistor for pin in Port B
            break;
            
        case 'C':
        case 'c':
            SET_BIT(GPIO_PORTC_PUR_R, pinnumber);  // Enable pull-up resistor for pin in Port C
            break;
            
        case 'D':
        case 'd':
            SET_BIT(GPIO_PORTD_PUR_R, pinnumber);  // Enable pull-up resistor for pin in Port D
            break;
            
        case 'E':
        case 'e':
            SET_BIT(GPIO_PORTE_PUR_R, pinnumber);  // Enable pull-up resistor for pin in Port E
            break;
            
        case 'F':
        case 'f':
            SET_BIT(GPIO_PORTF_PUR_R, pinnumber);  // Enable pull-up resistor for pin in Port F
            break;
            
        default:
            // Handle invalid portname
            break;
    }
}
...
void Button_InitPullUp(uint8_t portname,uint8_t pinnumber)
{
    ...
    GPIO_SetPinDirection(portname,pinnumber,0);
